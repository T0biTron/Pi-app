...
class _Section2ScreenState extends State<Section2Screen> {
  ...
  if (ageScore >= 36 && ageScore <= 41) { // 3-0 a 3-5
  ...
  else if (ageScore >= 42 && ageScore <= 47) { // 3-6 a 3-11
  ...
  else if (ageScore >= 48 && ageScore <= 53) { // 4-0 a 4-5
  if (puntajeBruto == 0) return "<1";
  ...
  else if (ageScore >= 54 && ageScore <= 59) { // 4-6 a 4-11
  ...
  else if (ageScore >= 60 && ageScore <= 65) { // 5-0 a 5-5
  ...
  else if (ageScore >= 66 && ageScore <= 71) { // 5-6 a 5-11
  ...
  else if (ageScore >= 72 && ageScore <= 77) { // 6-0 a 6-5
  ...
  else if (ageScore >= 78 && ageScore <= 83) { // 6-6 a 6-11
  ...
  else if (ageScore >= 84 && ageScore <= 89) { // 7-0 a 7-5
  ...
  else if (ageScore >= 90 && ageScore <= 95) { // 7-6 a 7-11
  ...
  else if (ageScore >= 96 && ageScore <= 107) { // 8-0 a 8-11
  ...
  else if (ageScore >= 108 && ageScore <= 131) { // 9-0 a 10-11
  ...
  else if (ageScore >= 42 && ageScore <= 47) { // 3-5 a 3-11
  ...
  if (puntajeBruto >= 25 && puntajeBruto <= 27) return "5";
  if (puntajeBruto >= 28 && puntajeBruto <= 29) return "6";
  if (puntajeBruto >= 30 && puntajeBruto <= 31) return "7";
  if (puntajeBruto >= 32 && puntajeBruto <= 33) return "8";
  if (puntajeBruto >= 34 && puntajeBruto <= 35) return "9";
  if (puntajeBruto >= 36 && puntajeBruto <= 37) return "10";
 ...
 String getLocomotoraIC90(int puntajeBruto) {
  String escalaPuntajeStr = getLocomotoraEP(widget.totalLocomotoraScore, widget.ageScore);
  ...
  if (escalaPuntajeStr.isNotEmpty && int.tryParse(escalaPuntajeStr) != null) {
    ...
    print("Error: valor no válido para convertir a entero - $escalaPuntajeStr");
  ...
  int escalaPuntaje = int.parse(getLocomotoraEP(widget.totalLocomotoraScore, widget.ageScore));
  ...
  int escalaPuntaje = int.parse(getLocomotoraEP(puntajeBruto, widget.ageScore));
  if (escalaPuntaje >= 1 && escalaPuntaje <= 3) return "Deterioro o retraso";
  if (escalaPuntaje >= 4 && escalaPuntaje <= 5) return "Borde del deterioro o retraso";
  if (escalaPuntaje >= 6 && escalaPuntaje <= 7) return "Por debajo del promedio";
  if (escalaPuntaje >= 8 && escalaPuntaje <= 12) return "Promedio";
  if (escalaPuntaje >= 13 && escalaPuntaje <= 14) return "Encima del promedio";
  if (escalaPuntaje >= 15 && escalaPuntaje <= 16) return "Superior";
  if (escalaPuntaje >= 17 && escalaPuntaje <= 20) return "Con talento o muy avanzado";
  return "";
  }
  ...
  String getPelotaEQ(int puntajeBruto, String? gender) {
    if (gender == 'Femenino' && puntajeBruto < 14) {
      ...
      return "4-0";
    } else if (gender == 'Femenino' && puntajeBruto >= 17 && puntajeBruto <= 18) {
      return "4-3";
    } else if (gender == 'Femenino' && puntajeBruto >= 19 && puntajeBruto <= 20) {
      return "4-6";
    } else if (gender == 'Femenino' && puntajeBruto == 21) {
      return "4-9";
    } else if (gender == 'Femenino' && puntajeBruto >= 22 && puntajeBruto <= 23) {
      return "5-0";
    } else if (gender == 'Femenino' && puntajeBruto >= 24 && puntajeBruto <= 25) {
      return "5-3";
    } else if (gender == 'Femenino' && puntajeBruto >= 26 && puntajeBruto <= 27) {
      return "5-6";
    } else if (gender == 'Femenino' && puntajeBruto == 28) {
      return "5-9";
    } else if (gender == 'Femenino' && puntajeBruto >= 29 && puntajeBruto <= 31) {
      return "6-0";
    } else if (gender == 'Femenino' && puntajeBruto >= 32 && puntajeBruto <= 33) {
      return "6-3";
      ...
      return "7-6";
    } else if (gender == 'Femenino' && puntajeBruto >= 38 && puntajeBruto <= 39) {
      return "7-9";
      ...
      return "3-0";
    } else if (gender == 'Masculino' && puntajeBruto >= 18 && puntajeBruto <= 19) {
      return "3-6";
    } else if (gender == 'Masculino' && puntajeBruto == 20) {
      return "3-9";
    } else if (gender == 'Masculino' && puntajeBruto >= 21 && puntajeBruto <= 22) {
      return "4-0";
    } else if (gender == 'Masculino' && puntajeBruto == 23) {
      return "4-3";
    } else if (gender == 'Masculino' && puntajeBruto >= 24 && puntajeBruto <= 25) {
      return "4-6";
    } else if (gender == 'Masculino' && puntajeBruto >= 26 && puntajeBruto <= 27) {
      return "4-9";
    } else if (gender == 'Masculino' && puntajeBruto >= 28 && puntajeBruto <= 29) {
      return "5-0";
    } else if (gender == 'Masculino' && puntajeBruto == 30) {
      return "5-3";
    } else if (gender == 'Masculino' && puntajeBruto >= 31 && puntajeBruto <= 33) {
      return "5-6";
    } else if (gender == 'Masculino' && puntajeBruto >= 34 && puntajeBruto <= 35) {
      return "5-9";
  ...
  if (ageScore >= 36 && ageScore <= 41 && gender == "Femenino") { // 3-0 a 3-5
  if (puntajeBruto >= 0 && puntajeBruto <= 1 ) return "<1";
  ...
  else if (ageScore >= 42 && ageScore <= 47 && gender == "Femenino") { // 3-6 a 3-11
  if (puntajeBruto >= 0 && puntajeBruto <= 1) return "<1";
  if (puntajeBruto == 2) return "1";
  if (puntajeBruto == 3) return "2";
  ...
  else if (ageScore >= 48 && ageScore <= 59 && gender == "Femenino") { // 4-0 a 4-11
  if (puntajeBruto >= 0 && puntajeBruto <= 1) return "<1";
  ...
  else if (ageScore >= 60 && ageScore <= 65 && gender == "Femenino") { // 5-0 a 5-5
  if (puntajeBruto >= 0 && puntajeBruto <= 2) return "<1";
  ...
  else if (ageScore >= 66 && ageScore <= 71 && gender == "Femenino") { // 5-6 a 5-11
  ...
  else if (ageScore >= 72 && ageScore <= 77 && gender == "Femenino") { // 6-0 a 6-5
  ...
  else if (ageScore >= 78 && ageScore <= 83 && gender == "Femenino") { // 6-6 a 6-11
  if (puntajeBruto >= 0 && puntajeBruto <= 7) return "<1";
  if (puntajeBruto >= 8 && puntajeBruto <= 10) return "1";
  ...
  else if (ageScore >= 84 && ageScore <= 89 && gender == "Femenino") { // 7-0 a 7-5
  if (puntajeBruto >= 0 && puntajeBruto <= 10) return "<1";
  ...
  else if (ageScore >= 90 && ageScore <= 95 && gender == "Femenino") { // 7-6 a 7-11
  ...
  else if (ageScore >= 96 && ageScore <= 101 && gender == "Femenino") { // 8-0 a 8-5
  if (puntajeBruto >= 0 && puntajeBruto <= 12) return "<1";
  ...
  else if (ageScore >= 102 && ageScore <= 107 && gender == "Femenino") { // 8-6 a 8-11
  ...
  else if (ageScore >= 108 && ageScore <= 119 && gender == "Femenino") { // 9-0 a 9-11
  ...
  else if (ageScore >= 120 && ageScore <= 131 && gender == "Femenino") { // 9-0 a 9-11
  if (puntajeBruto >= 0 && puntajeBruto <= 20) return "<1";
  ...
  if (puntajeBruto == 54) return "95";
   ...
   if (ageScore >= 36 && ageScore <= 41 && gender == "Masculino") { // 3-0 a 3-5
  if (puntajeBruto == 0 ) return "<1";
  ...
  else if (ageScore >= 42 && ageScore <= 47 && gender == "Masculino") { // 3-6 a 3-11
  if (puntajeBruto >= 0 && puntajeBruto <= 1) return "<1";
  if (puntajeBruto >= 2 && puntajeBruto <= 3) return "1";
  if (puntajeBruto >= 4 && puntajeBruto <= 5) return "2";
  if (puntajeBruto >= 6 && puntajeBruto <= 7) return "5";
  ...
  else if (ageScore >= 48 && ageScore <= 53 && gender == "Masculino") { // 4-0 a 4-5
  if (puntajeBruto >= 0 && puntajeBruto <= 1) return "<1";
  if (puntajeBruto >= 2 && puntajeBruto <= 3) return "1";
  if (puntajeBruto >= 4 && puntajeBruto <= 6) return "2";
  if (puntajeBruto >= 7 && puntajeBruto <= 9) return "5";
  ...
  else if (ageScore >= 54 && ageScore <= 59 && gender == "Masculino") { // 4-6 a 4-11
  if (puntajeBruto >= 0 && puntajeBruto <= 1) return "<1";
  ...
  else if (ageScore >= 60 && ageScore <= 65 && gender == "Masculino") { // 5-0 a 5-5
  if (puntajeBruto >= 0 && puntajeBruto <= 3) return "<1";
  if (puntajeBruto >= 4 && puntajeBruto <= 6) return "1";
  ...
  else if (ageScore >= 66 && ageScore <= 71 && gender == "Masculino") { // 5-6 a 5-11
  ...
  else if (ageScore >= 72 && ageScore <= 77 && gender == "Masculino") { // 6-0 a 6-5
  if (puntajeBruto >= 0 && puntajeBruto <= 10) return "<1";
  if (puntajeBruto >= 11 && puntajeBruto <= 13) return "1";
  ...
  else if (ageScore >= 78 && ageScore <= 83 && gender == "Masculino") { // 6-6 a 6-11
  if (puntajeBruto >= 0 && puntajeBruto <= 13) return "<1";
  if (puntajeBruto >= 14 && puntajeBruto <= 17) return "1";
  if (puntajeBruto >= 18 && puntajeBruto <= 20) return "2";
  if (puntajeBruto >= 21 && puntajeBruto <= 23) return "5";
  if (puntajeBruto >= 24 && puntajeBruto <= 26) return "9";
  if (puntajeBruto >= 27 && puntajeBruto <= 30) return "16";
  if (puntajeBruto >= 31 && puntajeBruto <= 35) return "25";
  if (puntajeBruto >= 36 && puntajeBruto <= 37) return "37";
  if (puntajeBruto >= 38 && puntajeBruto <= 40) return "50";
  if (puntajeBruto >= 41 && puntajeBruto <= 42) return "63";
  if (puntajeBruto >= 43 && puntajeBruto <= 44) return "75";
  if (puntajeBruto >= 45 && puntajeBruto <= 47) return "84";
  if (puntajeBruto >= 48 && puntajeBruto <= 49) return "91";
  if (puntajeBruto >= 50 && puntajeBruto <= 52) return "95";
  if (puntajeBruto == 53) return "98";
  if (puntajeBruto == 54) return "99";
  }
  else if (ageScore >= 84 && ageScore <= 89 && gender == "Masculino") { // 7-0 a 7-5
  if (puntajeBruto >= 0 && puntajeBruto <= 17) return "<1";
  if (puntajeBruto >= 18 && puntajeBruto <= 20) return "1";
  if (puntajeBruto >= 21 && puntajeBruto <= 23) return "2";
  if (puntajeBruto >= 24 && puntajeBruto <= 26) return "5";
  if (puntajeBruto >= 27 && puntajeBruto <= 30) return "9";
  if (puntajeBruto >= 31 && puntajeBruto <= 35) return "16";
  if (puntajeBruto >= 36 && puntajeBruto <= 37) return "25";
  if (puntajeBruto >= 38 && puntajeBruto <= 39) return "37";
  if (puntajeBruto >= 40 && puntajeBruto <= 41) return "50";
  if (puntajeBruto >= 42 && puntajeBruto <= 43) return "63";
  if (puntajeBruto == 44) return "75";
  if (puntajeBruto >= 45 && puntajeBruto <= 48) return "84";
  if (puntajeBruto >= 49 && puntajeBruto <= 51) return "91";
  if (puntajeBruto >= 52 && puntajeBruto <= 53) return "95";
  if (puntajeBruto == 54) return "98";
  }
  else if (ageScore >= 90 && ageScore <= 95 && gender == "Masculino") { // 7-6 a 7-11
  if (puntajeBruto >= 0 && puntajeBruto <= 20) return "<1";
  if (puntajeBruto >= 21 && puntajeBruto <= 23) return "1";
  if (puntajeBruto >= 24 && puntajeBruto <= 26) return "2";
  if (puntajeBruto >= 27 && puntajeBruto <= 30) return "5";
  if (puntajeBruto >= 31 && puntajeBruto <= 34) return "9";
  if (puntajeBruto >= 35 && puntajeBruto <= 37) return "16";
  if (puntajeBruto >= 38 && puntajeBruto <= 39) return "25";
  if (puntajeBruto >= 40 && puntajeBruto <= 41) return "37";
  if (puntajeBruto >= 42 && puntajeBruto <= 43) return "50";
  if (puntajeBruto == 44) return "63";
  if (puntajeBruto >= 45 && puntajeBruto <= 48) return "75";
  if (puntajeBruto >= 49 && puntajeBruto <= 51) return "84";
  if (puntajeBruto >= 52 && puntajeBruto <= 53) return "91";
  if (puntajeBruto == 54) return "95";
  }
  else if (ageScore >= 96 && ageScore <= 107 && gender == "Masculino") { // 8-0 a 8-11
  if (puntajeBruto >= 0 && puntajeBruto <= 23) return "<1";
  if (puntajeBruto >= 24 && puntajeBruto <= 26) return "1";
  if (puntajeBruto >= 27 && puntajeBruto <= 30) return "2";
  if (puntajeBruto >= 31 && puntajeBruto <= 33) return "5";
  if (puntajeBruto >= 34 && puntajeBruto <= 35) return "9";
  if (puntajeBruto >= 36 && puntajeBruto <= 37) return "16";
  if (puntajeBruto >= 38 && puntajeBruto <= 40) return "25";
  if (puntajeBruto >= 41 && puntajeBruto <= 42) return "37";
  if (puntajeBruto >= 43 && puntajeBruto <= 44) return "50";
  if (puntajeBruto >= 45 && puntajeBruto <= 47) return "63";
  if (puntajeBruto >= 48 && puntajeBruto <= 49) return "75";
  if (puntajeBruto >= 50 && puntajeBruto <= 51) return "84";
  if (puntajeBruto >= 52 && puntajeBruto <= 53) return "91";
  if (puntajeBruto == 54) return "95";
  }
  else if (ageScore >= 108 && ageScore <= 131 && gender == "Masculino") { // 9-0 a 10-11
  if (puntajeBruto >= 0 && puntajeBruto <= 26) return "<1";
  if (puntajeBruto >= 27 && puntajeBruto <= 29) return "1";
  if (puntajeBruto >= 30 && puntajeBruto <= 32) return "2";
  if (puntajeBruto >= 33 && puntajeBruto <= 35) return "5";
  if (puntajeBruto >= 36 && puntajeBruto <= 37) return "9";
  if (puntajeBruto >= 38 && puntajeBruto <= 40) return "16";
  if (puntajeBruto >= 41 && puntajeBruto <= 42) return "25";
  if (puntajeBruto >= 43 && puntajeBruto <= 44) return "37";
  if (puntajeBruto >= 45 && puntajeBruto <= 47) return "50";
  if (puntajeBruto >= 48 && puntajeBruto <= 49) return "63";
  if (puntajeBruto == 50) return "75";
  if (puntajeBruto >= 51 && puntajeBruto <= 52) return "84";
  if (puntajeBruto == 53) return "91";
  if (puntajeBruto == 54) return "95";
  }
  ...
  else if (ageScore >= 120 && ageScore <= 131 && gender == "Femenino") { // 10-0 a 10-11
  if (puntajeBruto >= 0 && puntajeBruto <= 17) return "1";
  if (puntajeBruto >= 18 && puntajeBruto <= 20) return "2";
  ...
  else if (ageScore >= 48 && ageScore <= 53 && gender == "Masculino") { // 4-6 a 4-11
  if (puntajeBruto == 0) return "1";
  if (puntajeBruto == 1) return "2";
  ...
  if (puntajeBruto >= 0 && puntajeBruto <= 10) return "1";
  if (puntajeBruto >= 11 && puntajeBruto <= 13) return "2";
  if (puntajeBruto >= 14 && puntajeBruto <= 17) return "3";
  if (puntajeBruto >= 18 && puntajeBruto <= 20) return "4";
  if (puntajeBruto >= 21 && puntajeBruto <= 23) return "5";
  if (puntajeBruto >= 24 && puntajeBruto <= 26) return "6";
  if (puntajeBruto >= 27 && puntajeBruto <= 30) return "7";
  if (puntajeBruto >= 31 && puntajeBruto <= 35) return "8";
  if (puntajeBruto >= 36 && puntajeBruto <= 37) return "9";
  if (puntajeBruto >= 38 && puntajeBruto <= 40) return "10";
  if (puntajeBruto >= 41 && puntajeBruto <= 42) return "11";
  if (puntajeBruto >= 43 && puntajeBruto <= 44) return "12";
  if (puntajeBruto >= 45 && puntajeBruto <= 47) return "13";
  if (puntajeBruto >= 48 && puntajeBruto <= 49) return "14";
  if (puntajeBruto >= 50 && puntajeBruto <= 52) return "15";
  if (puntajeBruto == 53) return "16";
  if (puntajeBruto == 54) return "17";
  }
  else if (ageScore >= 84 && ageScore <= 89 && gender == "Masculino") { // 7-0 a 7-5
  if (puntajeBruto >= 0 && puntajeBruto <= 13) return "1";
  ...
  int escalaPuntaje = int.parse(getPelotaEP(widget.totalPelotaScore, widget.ageScore, widget.gender));
  if (escalaPuntaje == 1) return "1-4";
  if (escalaPuntaje == 2) return "1-5";
  if (escalaPuntaje == 3) return "2-5";
  if (escalaPuntaje == 4) return "3-6";
  ...
  String getSumEP(int puntajeBrutoLocomotora, int puntajeBrutoPelota, int ageScore, String? gender) {
  int locomotoraEP = int.parse(getLocomotoraEP(puntajeBrutoLocomotora, ageScore));
  ...
  String getDifEP(int puntajeBrutoLocomotora, int puntajeBrutoPelota, int ageScore, String? gender) {
  int locomotoraEP = int.parse(getLocomotoraEP(puntajeBrutoLocomotora, ageScore));
  int pelotaEP = int.parse(getPelotaEP(puntajeBrutoPelota, ageScore, gender));
  ...
  String getEstado(int puntajeBrutoLocomotora, int puntajeBrutoPelota, int ageScore, String? gender) {
  int locomotoraEP = int.parse(getLocomotoraEP(puntajeBrutoLocomotora, ageScore));
  int pelotaEP = int.parse(getPelotaEP(puntajeBrutoPelota, ageScore, gender));
  ...
  void initState() {
  super.initState();
  _locomotoraPBController = TextEditingController(text: widget.totalLocomotoraScore.toString());
  _locomotoraEQController = TextEditingController(text: getLocomotoraEQ(widget.totalLocomotoraScore));
  _locomotoraRPController = TextEditingController(text: getLocomotoraRP(widget.totalLocomotoraScore, widget.ageScore));
  _locomotoraEPController = TextEditingController(text: getLocomotoraEP(widget.totalLocomotoraScore, widget.ageScore));
  _locomotoraIC90Controller = TextEditingController(text: getLocomotoraIC90(widget.totalLocomotoraScore));
  _locomotoraIC95Controller = TextEditingController(text: getLocomotoraIC95(widget.totalLocomotoraScore));
  _locomotoraTDController = TextEditingController(text: getLocomotoraTD(widget.totalLocomotoraScore));
  _pelotaPBController = TextEditingController(text: widget.totalPelotaScore.toString());
  _pelotaEQController = TextEditingController(text: getPelotaEQ(widget.totalPelotaScore, widget.gender));
  _pelotaRPController = TextEditingController(text: getPelotaRP(widget.totalPelotaScore, widget.ageScore, widget.gender));
  _pelotaEPController = TextEditingController(text: getPelotaEP(widget.totalPelotaScore, widget.ageScore, widget.gender));
  _pelotaIC90Controller = TextEditingController(text: getPelotaIC90(widget.totalPelotaScore));
  _pelotaIC95Controller = TextEditingController(text: getPelotaIC95(widget.totalPelotaScore));
  _pelotaTDController = TextEditingController(text: getPelotaTD(widget.totalPelotaScore));
  _sumEPController = TextEditingController(text: getSumEP(widget.totalLocomotoraScore, widget.totalPelotaScore, widget.ageScore, widget.gender));
  _difEPController = TextEditingController(text: getDifEP(widget.totalLocomotoraScore, widget.totalPelotaScore, widget.ageScore, widget.gender));
  _estadoController = TextEditingController(text: getEstado(widget.totalLocomotoraScore, widget.totalPelotaScore, widget.ageScore, widget.gender));
}
      ...
      appBar: AppBar(
        title: const Column(
          ...
          children: [
            ...
            Text('Rendimiento de las subpruebas', style: TextStyle(fontSize: 20)),
          ],
        ),
        leading: IconButton(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text('Intervalo de Confianza', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                  Row(
                    children: [
                      Expanded(
                        child: TextField(
                      ...
                      Navigator.pushReplacement(
                        ...
                        MaterialPageRoute(
                          builder: (context) => Section3Screen(
                            ...
                            totalLocomotoraScore: widget.totalLocomotoraScore,
                            totalPelotaScore: widget.totalPelotaScore,
                            sumEP: int.parse(getSumEP(widget.totalLocomotoraScore, widget.totalPelotaScore, widget.ageScore, widget.gender)),
                            ageScore: widget.ageScore,
                          ),
                        ),
                      );
